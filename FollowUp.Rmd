...
the Biocondoctor-standard SCE format eases interfacing with any of the plethora
...
full_sce <- full_sce[, !is.na(full_sce$cluster)]
colnames(full_sce) <- paste0("cell_", seq_len(ncol(full_sce)))
```
